  ...
  Controller.click = {
    ...
    Day: function(target) {
      ...
      if (view.form.check(data)) {
        ...
        Dom.get(document, " body > form ").item(0).style.display = "none";
        ...
        target.classList.add("keep");
        return calendar.style.height = (window.innerHeight - (Dom.get(target, "section").item(0).offsetHeight)) + "px";
      }
    },
    ...
    ScheduleClose: function(target) {
      ...
      return calendar.style.height = null;
    },
...
MouseEvent = (function() {
  ...
  MouseEvent.mouse = {
    ...
    clickEvent: function(evt) {
      var cls, point, _i, _len, _ref, _results;
...
PropertySetting = (function() {
  ...
  function PropertySetting() {
    ...
    window.addEventListener("mousemove", function(evt) {
      var nav;
      if (nav = MouseEvent.getPointer(evt, "NAV")) {
        return nav.style.height = "auto";
      } else {
        return Dom.get(document, "body > nav ").item(0).style.height = null;
      }
    });
  }
